...
class LoginForm1 {
    ...
    async submitForm() {
        ...
        try {
            ...
            console.log('FormUtils available:', typeof FormUtils);
            console.log('All registered users:', FormUtils.getAllUsers());
            
            // Validate user against registered users
            const user = FormUtils.validateUserLogin(email, password);
